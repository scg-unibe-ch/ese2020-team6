...
const threadA = new Thread(1, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg7, msg8]);
let msg5 = new Message(5, 'Ich brauche was zu essen', new Date(), true);
let msg6 = new Message(5, 'dringend', new Date(), true);
const threadM = new Thread(2, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg5, msg6]);

let msg3 = new Message(6, 'Ich liebe Pizza', new Date(), true);
let msg4 = new Message(6, 'Warum habe ich keine Pizza?', new Date(), true);
const threadL = new Thread(3, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg3, msg4]);
...
const threadS = new Thread(4, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg1, msg2]);

let msg = new Message(8, 'Hallo', new Date(), true);
const threadE = new Thread(5, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg]);

let msg9 = new Message(9, 'Lalalalalala', new Date(), true);
let msg10 = new Message(9, 'Heeeeey', new Date(), true);
const threadK = new Thread(6, Product.NullProduct, [User.NullUser, User.NullUser], true, [msg9, msg10]);

const threadJ = new Thread(7, Product.NullProduct, [User.NullUser, User.NullUser], true, []);
const threadH = new Thread(8, Product.NullProduct, [User.NullUser, User.NullUser], true, []);
const threadP = new Thread(9, Product.NullProduct, [User.NullUser, User.NullUser], true, []);
const threadN = new Thread(10, Product.NullProduct, [User.NullUser, User.NullUser], true, []);
